...
<div class="modal inmodal fade" id="insertModalCategoria" tabindex="-1" role="dialog" aria-hidden="true" style="display: none;">
    <div class="modal-dialog modal-md">
        <div class="modal-content">
            <div class="modal-header">
                <button type="button" class="close" data-dismiss="modal"><span aria-hidden="true">X</span><span class="sr-only">Close</span></button>
                <h4 class="modal-title pull-left">Gerenciar Categoria</h4>
            </div>
	                ...
	                <div class="row">	
	                	<div class="col-sm-6">        
	                            <div class="form-group">
	                                ...
	                                <input type="text" name="descTxt" id="descTxt" placeholder="Descição da Categoria" class="form-control input-sm">
	                            </div>
	                    </div>
	                </div>
	                <div class="row">	
    ...
    <script>
        $(document).ready(function(){
            ...
            $(document).on('click', '#btnInsert, #btnUpdate', function (e) {
                ...
                $('#insertModalCategoria').modal('show');
